...
constexpr int kGridOuterRadius = 224;
...
constexpr int kCardinalLabelHeightPx = 24;
...
constexpr int kAircraftNoseLenPx = 14;
constexpr int kAircraftTailLenPx = 5;
constexpr int kAircraftTailHalfPx = 7;
